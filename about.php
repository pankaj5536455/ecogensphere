...
// Fetch data from the about_content table
// Replace the below query with your actual query to fetch data from the database
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-3 info_col">
                    <div class="info_detail">
                        ...
                        <p>
                            Empowering Sustainability: Harnessing Nature's Wisdom with Innovative Technology. Join us
                            in shaping a brighter, eco-friendly future.
                        </p>
                    </div>
                </div>
